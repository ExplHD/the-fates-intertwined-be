...
damage @e[tag=murasamaTag,type=fec:corvus] 25 entity_attack
...
damage @e[tag=murasamaTag,type=fec:water_eidolon] 18 entity_attack
damage @e[tag=murasamaTag,type=wither] 10 entity_attack
